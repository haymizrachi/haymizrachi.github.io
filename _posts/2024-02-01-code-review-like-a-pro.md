...
Hello everyone!
<br />
Welcome to my first blog post! I'm excited to be here. :grin:
...
Let's talk about the different approaches to perform Code Review, which are: 
1. Covering code line by line
2. Focusing on low-hanging fruit functions such as Login, Registration, and Password Reset mechanisms
3. Greping regex keywords for quick-wins
4. Following user input using bottom up and top down approaches
